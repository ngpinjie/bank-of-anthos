...
1. [Submit an issue](https://github.com/GoogleCloudPlatform/bank-of-anthos/issues/new) describing your proposed changes.
...
Please see the [development guide](../docs/development.md) to learn how to set up your local environment.
